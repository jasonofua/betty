...
# 25 Sep: and at most four legs, full stop. SG01YY went 7 legs at 19.89x and came
# back 2 of 6. Rebuilt over our own boards 14-25 Sep, taking the highest-return
# families first: a 4-leg cap lands 5 of 9 days and returns 2.48 per 1 staked;
# 5 legs 4 of 9 and 2.25; 8 legs 3 of 9 and 1.28; no cap 2 of 9 and 0.81. The
# qualifying families are 80-90% legs, so every leg past the fourth costs more
# in landing chance than it adds in price.
BEST_MAX_LEGS = 4
...
RULES = [
    ...
    dict(product='Bet of the day', tag='the best of the morning tickets',
         plain="Built at 10:12 after the morning runs. Every leg still to play on the day's tickets is sorted into its bet family (a winners straight win, a second-half Over 0.5, a hockey handicap...), and only the families in profit on our own settled legs over the WHOLE record - eight or more legs, 60% of them won, positive return at the booked prices - make the code. One leg per match, the family with the better record when two tickets have the same game, and at most two legs from any one competition and never more than four legs in total. Never booked under 2x.",
         thresholds=[dict(k='Family window', v='the whole record since 14 Sep'), dict(k='Family needs', v='8+ legs, 60%+ won, positive return'), dict(k='Winners legs', v='favourite at 1.30-1.60 only'), dict(k='Max-odds legs', v='model 6+ points over the book'), dict(k='Legs per competition', v='two'), dict(k='Legs on the slip', v='four'), dict(k='Minimum odds', v='2x'), dict(k='Legs per match', v='one')],
...
CHANGELOG = [
    dict(date='25 Sep', txt="Bet of the day capped at four legs. SG01YY went seven legs at 19.89x and came back 2 of 6 (Karlovy Vary 5:1 and Tychy 3:5 on the hockey handicaps, KaPa 3:2 and Lunds 0:1 on the football). Rebuilt over our own boards 14-25 Sep, highest-return families first: four legs lands 5 of 9 days for 2.48 back per 1 staked, five legs 4 of 9 for 2.25, eight legs 3 of 9 for 1.28, no cap 2 of 9 for 0.81. The qualifying families are 80-90% legs, so every leg past the fourth costs more landing chance than it buys in price."),
