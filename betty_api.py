...
CHANGELOG = [
    dict(date='21 Sep', txt="Draws, user's pattern: inside the four checks, the legs where SportyBet's Under 2.5 is exactly 1.38 or 1.50, or 1.41-1.43 with the table gap at 0.13, go on a second slip of their own so the record keeps its score. On the first 26 legs of the rule: 1.50 went 3 of 3, 1.38 went 2 of 2, and the two 0.13 / 1.41-1.43 games both finished 0-0 (one voided by SportyBet). The ticks in between - 1.42, 1.49 - lost."),
