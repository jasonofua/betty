...
CHANGELOG = [
    dict(date='21 Sep', txt="Draws, user's pattern: inside the four checks, the legs where the table gap is 0.08-0.17 a game AND SportyBet's Under 2.5 is 1.38-1.50 go on a second slip of their own, so the record keeps its score. On the first 26 legs of the rule: 4 drew, 1 drew and was voided, 2 lost; Under 1.50 went 3 of 3 and 1.38 2 of 2."),
